...
insert into employee(first_name, last_name, role_id, manager_id) values ('Carlos', 'Merr', 4, 1);
insert into employee(first_name, last_name, role_id, manager_id) values ('Sarah', 'King', 2, null);
insert into employee(first_name, last_name, role_id, manager_id) values ('Calra', 'Garcia', 7, 2);
insert into employee(first_name, last_name, role_id, manager_id) values ('Joe', 'Cassy', 3, null);
insert into employee(first_name, last_name, role_id, manager_id) values ('Carlos', 'Plato', 8, 3);
insert into employee(first_name, last_name, role_id, manager_id) values ('John', 'Moori', 4, null);
insert into employee(first_name, last_name, role_id, manager_id) values ('Dan', 'Moo', 9, 4);
insert into employee(first_name, last_name, role_id, manager_id) values ('John', 'Gonzales', 5, null);
insert into employee(first_name, last_name, role_id, manager_id) values ('Bertha', 'Bii', 6, 2);
insert into employee(first_name, last_name, role_id, manager_id) values ('John', 'Niki', 1, 2);
insert into employee(first_name, last_name, role_id, manager_id) values ('Carlos', 'Mess',7, 3);
